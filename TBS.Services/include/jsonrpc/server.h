...
namespace jsonrpc
{
    ...
    class AbstractServer : public AbstractRequestHandler
    {
        public:
            ...
            AbstractServer(SingleServerConnector::Ptr connector) :
            ...
            AbstractServer(const std::string &configfile, SingleServerConnector::Ptr connector) :
            ...
            /**
             * @brief StartListening starts the SingleServerConnector to listen for incoming requests.
             * @return
             */
            ...
            /**
             * @brief StopListening stops the SingleServerConnector, no more requests will be answered.
             * @return
             */
        ...
        private:
            SingleServerConnector::Ptr connection;
