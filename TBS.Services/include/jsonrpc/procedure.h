...
namespace jsonrpc
{
    ...
    class Procedure
    {
        public:
    		...
    		typedef Poco::SharedPtr<Map> MapPtr;
             ...
             */
            bool ValdiateParameters(Json::Value &parameters, bool fixParam);
        ...
        private:
            ...
            bool ValidateNamedParameters(Json::Value &parameters, bool fixParam);
            bool ValidatePositionalParameters(Json::Value &parameters, bool fixParam);
            bool ValidateSingleParameter(jsontype_t expectedType, Json::Value &value, bool fixParam);
    };
