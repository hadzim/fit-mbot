...
namespace jsonrpc
{
    ...
    Json::Value Errors::GetCustomErrorBlock(const Json::Value& request, const int& errorCode, const std::string & message){
    	Json::Value error = GetErrorBlock(request, errorCode);
