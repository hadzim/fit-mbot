...
namespace jsonrpc {
	...
	Procedure::MapPtr SpecificationParser::GetProceduresFromFile(const string &filename) 
     {
         string content;
	...
	Procedure::MapPtr SpecificationParser::GetProceduresFromString(const string &content) 
    {
        ...
        Procedure::MapPtr procedures = new Procedure::Map();
        Procedure::Ptr proc;
    ...
    Procedure::Ptr SpecificationParser::GetProcedure(Json::Value &signature)
    {
        procedure_t procedureType;
        std::string name_key;
        std::string procedureName;
        Procedure::Ptr result;
