...
// Utility.h
//
// $Id: //poco/1.4/Data/SQLiteCipher/include/Poco/Data/SQLiteCipher/Utility.h#1 $
//
...
#ifndef SQLiteCipher_Utility_INCLUDED
#define SQLiteCipher_Utility_INCLUDED
...
class SQLiteCipher_API Utility
	/// Various utility functions for SQLiteCipher, mostly return code handling
{
public:
	typedef std::map<std::string, MetaColumn::ColumnDataType> TypeMap;
		/// Maps SQLiteCipher column declared types to Poco::Data types through
		/// static TypeMap member.
		/// Note: SQLiteCipher is type-agnostic and it is the end-user responsibility
