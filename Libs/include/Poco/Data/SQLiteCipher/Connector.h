...
// Connector.h
//
// $Id: //poco/1.4/Data/SQLiteCipher/include/Poco/Data/SQLiteCipher/Connector.h#1 $
//
...
#ifndef DataConnectors_SQLiteCipher_Connector_INCLUDED
#define DataConnectors_SQLiteCipher_Connector_INCLUDED
...
class SQLiteCipher_API Connector: public Poco::Data::Connector
	/// Connector instantiates SqLite SessionImpl objects.
{
public:
	static const std::string KEY;
		/// Keyword for creating SQLiteCipher sessions ("SQLiteCipher").
	...
	Poco::AutoPtr<Poco::Data::SessionImpl> createSession(const std::string& connectionString);
		/// Creates a SQLiteCipher SessionImpl object and initializes it with the given connectionString.
	...
	static void enableSoftHeapLimit(int limit);
		...
		/// by SQLiteCipher. For more information, please see the SQLiteCipher
...
#endif // DataConnectors_SQLiteCipher_Connector_INCLUDED
