...
./../../TBS.Services/TBS.Services.Generator.lin/TBS.Services.Generator --def=manipulator.xml --name=Manipulator --src=$SRC_PATH/ --include=$INCLUDE_PATH/ --relative=$RELATIVE_PATH/ --javascript=../js --generate=json
